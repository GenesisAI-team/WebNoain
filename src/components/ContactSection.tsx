...
export const ContactSection: React.FC = () => {
  return (
    <section
      id="contacto"
      className="w-full bg-slate-900 py-24 px-6 md:px-12 lg:px-24 border-t border-white/5 relative scroll-mt-20"
    >
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center group bg-slate-950 p-8 border border-slate-800 rounded-sm hover:border-[#FF6B95] transition-all duration-300">
            ...
            <h4 className="text-white font-bold uppercase tracking-wider mb-4 text-lg">
              Polideportivo Municipal
            </h4>
            <p className="text-slate-400 text-sm leading-relaxed font-medium">
              Calle Real, 24
              <br />
              31110 Noáin (Valle de Elorz)
              <br />
              Navarra
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center group bg-slate-950 p-8 border border-slate-800 rounded-sm hover:border-[#FF6B95] transition-all duration-300">
            ...
            <a
              href="mailto:info@cvnoain.com"
              className="text-slate-400 text-sm leading-relaxed font-medium hover:text-[#FF6B95] transition-colors"
            >
              cvnoain@gmail.com
            </a>
          </div>
