...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Ven a conocernos.",
    icon: UserPlus,
  },
  {
    id: 3,
    title: "¡YA ERES DEL RAYO!",
    desc: "Formaliza la ficha y todo listo. Bienvenido al equipo.",
    icon: Shield,
  },
];

const BENEFITS = [
  "Campamentos del club",
  "Tecnificaciones del club",
...
export const JoinUsSection: React.FC = () => {
  return (
    <section
      id="inscripciones"
      className="relative w-full py-24 px-6 md:px-12 lg:px-24 overflow-hidden bg-slate-950 scroll-mt-20"
    >
      {/* --- BACKGROUND EFFECTS --- */}
      ...
      <svg
        className="absolute top-10 right-[-10%] md:right-10 w-[40rem] h-[40rem] text-white/5 -rotate-12 pointer-events-none"
        viewBox="0 0 24 24"
        fill="currentColor"
      >
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col items-start text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#FF6B95]/10 border border-[#FF6B95]/30 rounded-full mb-8">
            ...
            <span className="text-[#FF6B95] font-bold text-xs uppercase tracking-widest">
              Plazas limitadas 26/27
            </span>
          </div>
          ...
          <h2 className="text-5xl md:text-7xl font-black text-white italic tracking-tighter leading-[0.9] mb-6 drop-shadow-lg">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF6B95] to-purple-500 pr-2 py-1">
              ÚNETE AL RAYO
            </span>
          </h2>

          <p className="text-lg text-slate-300 font-medium mb-10 max-w-lg leading-relaxed">
            Buscamos gente con pasión, garra y compromiso. Da igual tu nivel,
            tenemos un hueco para ti en nuestra familia. ¿Te atreves?
          </p>

          <div className="flex flex-col sm:flex-row gap-4 w-full">
            <a
              href="https://docs.google.com/forms/d/e/1FAIpQLSfuOQdIj502zxXxkjY2p860Re2kPC43j5ukU6ZabWtjY0OtvA/viewform?usp=publish-editor"
              target="_blank"
