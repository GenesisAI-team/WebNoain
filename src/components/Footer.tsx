      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start lg:items-end gap-12">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-slate-400 text-sm max-w-sm">
            Fomentando el deporte base y la competición de alto nivel en
            Navarra.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end gap-10 lg:gap-20 w-full lg:w-auto">
          ...
          <div className="flex flex-col gap-3 text-xs font-bold uppercase tracking-widest text-slate-500">
            <a href="#" className="hover:text-[#FF6B95] transition-colors">
              Aviso Legal
            </a>
            <a href="#" className="hover:text-[#FF6B95] transition-colors">
          ...
          <div className="flex gap-4">
            <a
              href="#"
              className="w-12 h-12 bg-slate-900 border border-slate-800 rounded-full flex items-center justify-center text-white hover:bg-[#FF6B95] hover:border-[#FF6B95] hover:-translate-y-1 transition-all duration-300"
            >
